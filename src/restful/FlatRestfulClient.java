...
/**
 * Jersey REST client generated for REST resource:FlatFacadeREST
 * [entities.flat]<br>
 * USAGE:
 * <pre>
 *        FlatRestfulClient client = new FlatRestfulClient();
...
public class FlatRestfulClient implements FlatManager{
    ...
    public FlatRestfulClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.flat");
    }

    public <T> T findByNofRooms(Class<T> responseType, String nRooms) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("nRooms/{0}", new Object[]{nRooms}));
    ...
    public <T> T findFlatByNofBathrooms(Class<T> responseType, String nBathrooms) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("nBathrooms/{0}", new Object[]{nBathrooms}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
